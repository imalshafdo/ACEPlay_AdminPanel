...
const countryName = computed(() => 'Bangladesh')
...
const casinos = computed(() => {
  ...
  const filtered = raw.filter(c => c.countryGroup === 'bangladesh')
  return filtered.map(c => {
    ...
    return {
      ...
      promo: c.welcomeBonus?.title || 'New members welcome bonus package with extra rewards',
