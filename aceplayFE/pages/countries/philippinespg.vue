    ...
    <main class="main-layout">
      ...
      <aside class="sidebar">
        ...
        <div class="filter-group">
          ...
          <label class="checkbox-label">
            <input type="checkbox" v-model="selectedPayments" value="e-wallet" class="custom-checkbox" />
            <span class="icon-text"><span class="icon-placeholder payment-icon" style="color:red">💳</span> E-wallet</span>
          </label>
          <label class="checkbox-label">
            <input type="checkbox" v-model="selectedPayments" value="bank_transfer" class="custom-checkbox" />
            <span class="icon-text"><span class="icon-placeholder payment-icon" style="color:red">🏦</span> Bank Transfer</span>
          </label>
          <label class="checkbox-label">
...
const countryName = computed(() => 'Philippines')
...
const casinos = computed(() => {
  ...
  // Filter for philippines or philippinespg
  const filtered = raw.filter(c => c.countryGroup === 'philippines' || c.countryGroup === 'philippinespg')
  return filtered.map(c => {
    ...
    return {
      ...
      promo: c.welcomeBonus?.title || 'New members bonus package with extra rewards',
